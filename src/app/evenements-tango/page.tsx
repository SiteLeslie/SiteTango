...
const events = [
  {
    ...
    description: "Ma soirée de tango à Nice. Danse, rencontre et partage dans une atmosphère festive et chaleureuse.",
    href: "/evenements-tango/milonga-nice",
  },
  {
    title: "Show, Stage & DJ",
    description: "Spectacles scéniques, stages intensifs et musicalisation de milongas pour sublimer vos événements.",
    href: "/evenements-tango/show-tango",
  },
  {
    title: "Mariage, Anniversaire & Entreprise",
    description: "Offrez un moment de tango inoubliable à vos invités. Prestations sur mesure pour tous vos événements privés.",
    href: "/evenements-tango/tango-mariage-nice",
  },
];

export default function EvenementsTango() {
...
function EventCard({ event }: { event: (typeof events)[number] }) {
  return (
    <Link
      href={event.href}
      className="group bg-sable/40 border border-beige rounded-lg overflow-hidden hover:border-champagne hover:shadow-lg hover:shadow-champagne/10 transition-all duration-300 flex flex-col"
    >
