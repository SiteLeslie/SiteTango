...
export default function ShowClient({ hero }: Props) {
    ...
    <>
      ...
      <section className="relative h-[50vh] overflow-hidden">
        <div className="absolute inset-0 bg-charbon">
          <KsPhoto
            src={hero}
            alt="Show et stage de tango argentin"
            placeholderLabel="Photo hero show / stage"
            sizes="100vw"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-noir/30 via-charbon/10 to-transparent pointer-events-none" />
        </div>
      </section>
