...
const cours = [
  ...
  },
  {
    ...
    location: "Centre de Nice Masséna",
    paragraphs: [
      "Quel que soit votre niveau ou votre sexe, ce cours est ouvert à toutes les personnes désireuses de travailler leur technique personnelle.",
